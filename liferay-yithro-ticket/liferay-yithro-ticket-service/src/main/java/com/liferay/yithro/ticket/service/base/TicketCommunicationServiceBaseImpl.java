...
import com.liferay.yithro.ticket.service.TicketCommunicationService;
...
/**
 * Provides the base implementation for the ticket communication remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.yithro.ticket.service.impl.TicketCommunicationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.yithro.ticket.service.impl.TicketCommunicationServiceImpl
 * @generated
 */
public abstract class TicketCommunicationServiceBaseImpl
	extends BaseServiceImpl
	implements TicketCommunicationService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TicketCommunicationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.yithro.ticket.service.TicketCommunicationServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TicketCommunicationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		ticketCommunicationService = (TicketCommunicationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TicketCommunicationService.class.getName();
	}
	...
	@Reference
	protected com.liferay.yithro.ticket.service.TicketCommunicationLocalService
		ticketCommunicationLocalService;

	protected TicketCommunicationService ticketCommunicationService;
