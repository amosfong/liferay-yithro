...
/**
 * Provides the base implementation for the ticket status local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.yithro.ticket.service.impl.TicketStatusLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.yithro.ticket.service.impl.TicketStatusLocalServiceImpl
 * @generated
 */
public abstract class TicketStatusLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, TicketStatusLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TicketStatusLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.yithro.ticket.service.TicketStatusLocalServiceUtil</code>.
	 */
	...
	public TicketStatus createTicketStatus(long ticketStatusId) {
		return ticketStatusPersistence.create(ticketStatusId);
	}
	...
	public TicketStatus deleteTicketStatus(long ticketStatusId)
		...
		return ticketStatusPersistence.remove(ticketStatusId);
	}
	...
	public TicketStatus deleteTicketStatus(TicketStatus ticketStatus) {
		return ticketStatusPersistence.remove(ticketStatus);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TicketStatus.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ticketStatusPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return ticketStatusPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ticketStatusPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return ticketStatusPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public TicketStatus fetchTicketStatus(long ticketStatusId) {
		return ticketStatusPersistence.fetchByPrimaryKey(ticketStatusId);
	}
	...
	public TicketStatus getTicketStatus(long ticketStatusId)
		...
		return ticketStatusPersistence.findByPrimaryKey(ticketStatusId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ticketStatusLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TicketStatus.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ticketStatusId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(TicketStatus.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return ticketStatusLocalService.deleteTicketStatus(
			(TicketStatus)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return ticketStatusPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TicketStatus> getTicketStatuses(int start, int end) {
		return ticketStatusPersistence.findAll(start, end);
	}
	...
	public int getTicketStatusesCount() {
		return ticketStatusPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TicketStatusLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		ticketStatusLocalService = (TicketStatusLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TicketStatusLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ticketStatusPersistence.getDataSource();
	...
	protected TicketStatusLocalService ticketStatusLocalService;
