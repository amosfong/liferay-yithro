 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.yithro.ticket.service.impl.TicketWorkerLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.yithro.ticket.service.impl.TicketWorkerLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class TicketWorkerLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements TicketWorkerLocalService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TicketWorkerLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.yithro.ticket.service.TicketWorkerLocalServiceUtil</code>.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TicketWorker.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return ticketWorkerPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return ticketWorkerPersistence.countWithDynamicQuery(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return ticketWorkerLocalService.deleteTicketWorker(
			(TicketWorker)persistedModel);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TicketWorkerLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		ticketWorkerLocalService = (TicketWorkerLocalService)aopProxy;
	}
