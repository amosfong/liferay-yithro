...
public class TicketStructurePersistenceImpl
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, TicketStructureImpl.class, primaryKey);
		}
	}
	...
	public TicketStructure remove(Serializable primaryKey)
		...
		catch (NoSuchTicketStructureException noSuchEntityException) {
