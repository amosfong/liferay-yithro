...
import com.liferay.yithro.ticket.service.TicketStatusService;
...
/**
 * Provides the base implementation for the ticket status remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.yithro.ticket.service.impl.TicketStatusServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.yithro.ticket.service.impl.TicketStatusServiceImpl
 * @generated
 */
public abstract class TicketStatusServiceBaseImpl
	extends BaseServiceImpl
	implements TicketStatusService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TicketStatusService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.yithro.ticket.service.TicketStatusServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TicketStatusService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		ticketStatusService = (TicketStatusService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TicketStatusService.class.getName();
	}
	...
	@Reference
	protected com.liferay.yithro.ticket.service.TicketStatusLocalService
