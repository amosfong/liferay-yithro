...
public class TicketWorkerPersistenceImpl
	...
	public TicketWorker fetchByU_TEI(
		...
		if (useFinderCache) {
			finderArgs = new Object[] {userId, ticketEntryId};
		}
			...
			try {
				...
				if (useFinderCache) {
					finderCache.removeResult(
						_finderPathFetchByU_TEI, finderArgs);
				}
	...
	public TicketWorker fetchByTEI_P(
		...
		if (useFinderCache) {
			finderArgs = new Object[] {ticketEntryId, primary};
		}
		...
		if (result == null) {
			...
			try {
				...
				if (useFinderCache) {
					finderCache.removeResult(
						_finderPathFetchByTEI_P, finderArgs);
				}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, TicketWorkerImpl.class, primaryKey);
		}
	}
	...
	public TicketWorker remove(Serializable primaryKey)
		...
		catch (NoSuchTicketWorkerException noSuchEntityException) {
