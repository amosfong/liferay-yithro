...
public class TicketCommunicationPersistenceImpl
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, TicketCommunicationImpl.class, primaryKey);
		}
	}
	...
	public TicketCommunication create(long ticketCommunicationId) {
		...
		ticketCommunication.setCompanyId(CompanyThreadLocal.getCompanyId());
	...
	public TicketCommunication remove(Serializable primaryKey)
		...
		catch (NoSuchTicketCommunicationException noSuchEntityException) {
	...
	public List<TicketCommunication> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sql = sql.concat(TicketCommunicationModelImpl.ORDER_BY_JPQL);
			}
