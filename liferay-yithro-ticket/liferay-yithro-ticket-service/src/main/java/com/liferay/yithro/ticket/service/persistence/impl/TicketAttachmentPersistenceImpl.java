...
public class TicketAttachmentPersistenceImpl
	 ...
	 */
	@Override
	public TicketAttachment findByTicketCommunicationId_First(
			long ticketCommunicationId,
			OrderByComparator<TicketAttachment> orderByComparator)
		throws NoSuchTicketAttachmentException {

		TicketAttachment ticketAttachment = fetchByTicketCommunicationId_First(
	 ...
	 */
	@Override
	public TicketAttachment fetchByTicketCommunicationId_First(
		long ticketCommunicationId,
		OrderByComparator<TicketAttachment> orderByComparator) {

		List<TicketAttachment> list = findByTicketCommunicationId(
	 ...
	 */
	@Override
	public TicketAttachment findByTicketCommunicationId_Last(
			long ticketCommunicationId,
			OrderByComparator<TicketAttachment> orderByComparator)
		throws NoSuchTicketAttachmentException {

		TicketAttachment ticketAttachment = fetchByTicketCommunicationId_Last(
			ticketCommunicationId, orderByComparator);
	 ...
	 */
	@Override
	public TicketAttachment fetchByTicketCommunicationId_Last(
		long ticketCommunicationId,
		OrderByComparator<TicketAttachment> orderByComparator) {
	 ...
	 */
	@Override
	public TicketAttachment[] findByTicketCommunicationId_PrevAndNext(
		...
		try {
			...
			array[0] = getByTicketCommunicationId_PrevAndNext(
				session, ticketAttachment, ticketCommunicationId,
	...
	protected TicketAttachment getByTicketCommunicationId_PrevAndNext(
	...
	private static final String
		_FINDER_COLUMN_TICKETCOMMUNICATIONID_TICKETCOMMUNICATIONID_2 =
			"ticketAttachment.ticketCommunicationId = ?";
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, TicketAttachmentImpl.class, primaryKey);
		}
	}
	...
	public TicketAttachment updateImpl(TicketAttachment ticketAttachment) {
		...
		if (!_columnBitmaskEnabled) {
			...
			args = new Object[] {
				ticketAttachmentModelImpl.getTicketCommunicationId()
			};
			...
			if ((ticketAttachmentModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					ticketAttachmentModelImpl.getOriginalTicketCommunicationId()
				};
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByTicketCommunicationId =
			new FinderPath(
				...
				"findByTicketCommunicationId",
				new String[] {Long.class.getName()},
				TicketAttachmentModelImpl.TICKETCOMMUNICATIONID_COLUMN_BITMASK |
				TicketAttachmentModelImpl.CREATEDATE_COLUMN_BITMASK);
