...
@Component(
	property = {
		"com.liferay.portlet.css-class-wrapper=yithro-simple-ticket-search-portlet",
		"com.liferay.portlet.display-category=category.yithro",
		"javax.portlet.display-name=Search Tickets",
...
public class SimpleTicketSearchPortlet extends MVCPortlet {
}