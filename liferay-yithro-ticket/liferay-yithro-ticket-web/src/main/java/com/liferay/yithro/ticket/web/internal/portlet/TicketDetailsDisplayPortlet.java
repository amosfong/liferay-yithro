...
@Component(
	property = {
		"com.liferay.portlet.css-class-wrapper=yithro-ticket-details-display-portlet",
		"com.liferay.portlet.display-category=category.yithro",
		"javax.portlet.display-name=Ticket Details Display",
		"javax.portlet.expiration-cache=0",
		"com.liferay.portlet.header-portlet-css=/ticket_details_display/css/main.css",
...
public class TicketDetailsDisplayPortlet extends MVCPortlet {
