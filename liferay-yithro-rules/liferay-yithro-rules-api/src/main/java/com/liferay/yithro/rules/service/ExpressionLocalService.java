...
/**
 * Provides the local service interface for Expression. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ExpressionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ExpressionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ExpressionLocalServiceUtil} to access the expression local service. Add custom service methods to <code>com.liferay.yithro.rules.service.impl.ExpressionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public Expression createExpression(long expressionId);
	...
	public Expression deleteExpression(Expression expression);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Expression deleteExpression(long expressionId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Expression fetchExpression(long expressionId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Expression getExpression(long expressionId) throws PortalException;
