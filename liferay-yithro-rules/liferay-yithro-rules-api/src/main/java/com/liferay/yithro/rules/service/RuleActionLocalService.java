...
/**
 * Provides the local service interface for RuleAction. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RuleActionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RuleActionLocalService
	...
	public RuleAction addRuleAction(RuleAction ruleAction);
	...
	public RuleAction createRuleAction(long ruleActionId);
	...
	public RuleAction deleteRuleAction(long ruleActionId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public RuleAction deleteRuleAction(RuleAction ruleAction);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RuleAction fetchRuleAction(long ruleActionId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RuleAction getRuleAction(long ruleActionId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<RuleAction> getRuleActions(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public RuleAction updateRuleAction(RuleAction ruleAction);
