...
/**
 * Provides the local service interface for Action. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ActionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ActionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ActionLocalServiceUtil} to access the action local service. Add custom service methods to <code>com.liferay.yithro.rules.service.impl.ActionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
